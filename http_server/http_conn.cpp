//
// Created by daqige on 2021/1/11.
//
...
const char *doc_root = "/home/daqige/Desktop/www/html";
...
// 因为有oneshot存在所以需要每次io复用后重新注册epoll
        ...
        switch (m_check_state) {
            ...
            case CHECK_STATE_HEADER: {
                ...
                if (ret == BAD_REQUEST) {
                    ...
                    // 有两个关于GET_REQUEST的判断是因为http请求不一定有消息体，如果没有的话在分析完header后就可以返回
...
// 本函数是发送数据的基础函数，用一个可变参数列表承接各个具体的发送函数
